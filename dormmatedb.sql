...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2020 at 08:58 AM
...
--
-- Table structure for table `bookmarklobby`
--

CREATE TABLE `bookmarklobby` (
  `BOOKMARKID` int(16) NOT NULL,
  `LOBBYID` int(9) NOT NULL,
...
(85, 'Waiting', 9, 'Roommates for hire', 'Near talamban campus, im a pyschology student. Need inspiration for finals', '2020-12-11', 37, 4, 2, 16, 21, 'Male', 'Yes', 'T', 'T', 'T'),
(96, 'Waiting', 1, 'Looking for Roomies', 'Near talamban campus, im a pyschology student. Need inspiration for finals', '2020-12-10', 16, 12, 1, 19, 27, 'Female', 'Yes', 'T', 'F', 'T'),
(97, 'Waiting', 12, 'Roommates for hire', 'I need 2 roommates preferably engineering students so we can help each other out in times of exams.', '0000-00-00', 8, 3, 1, 16, 22, 'Male', 'Yes', 'T', 'T', 'T'),
(98, 'Waiting', 11, 'Roommates x Artist', 'Needs atleast 2 roommates to live with me on south street talamban', '2020-12-09', 4, 2, 1, 25, 27, 'Male', 'Yes', 'T', 'T', 'T');
...
(4, '2020-12-11', '2:46 pm', 'So kanus.a mo gusto mag sugod tag empaki?', 'T', 9, 85);
...
CREATE TABLE `users` (
  ...
  `PROFILEPICTURE` varchar(1028) DEFAULT NULL,
...
(14, 'hosea', 'johnangeloal282@gmail.com', 'F', 'asd', 0, 0, NULL, 'hosea', 'barriga', 'Male', '2020-12-16', '', '', '', 'Secondary', 'F', 'No', 'No', 'Yes');
...
--
-- Indexes for table `bookmarklobby`
--
ALTER TABLE `bookmarklobby`
  ADD PRIMARY KEY (`BOOKMARKID`),
  ADD KEY `BOOKMARKLOBBY_FK1` (`LOBBYID`),
  ADD KEY `BOOKMARKLOBBY_FK2` (`USERID`);
...
--
ALTER TABLE `applicants`
  MODIFY `CHATROOMID` int(128) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `bookmarklobby`
--
ALTER TABLE `bookmarklobby`
  MODIFY `BOOKMARKID` int(16) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `lobby`
--
ALTER TABLE `lobby`
  MODIFY `LOBBYID` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;

--
-- AUTO_INCREMENT for table `location`
--
ALTER TABLE `location`
  MODIFY `LOCATIONID` int(128) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT for table `roommate`
--
ALTER TABLE `roommate`
  MODIFY `ROOMMATEID` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `roommatechat`
--
ALTER TABLE `roommatechat`
  MODIFY `ROOMCHATID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `USERID` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- Constraints for table `bookmarklobby`
--
ALTER TABLE `bookmarklobby`
  ADD CONSTRAINT `BOOKMARKLOBBY_FK1` FOREIGN KEY (`LOBBYID`) REFERENCES `lobby` (`LOBBYID`),
  ADD CONSTRAINT `BOOKMARKLOBBY_FK2` FOREIGN KEY (`USERID`) REFERENCES `users` (`USERID`);
